...
CREATE TABLE `tb_tk_appform` (
  `appf_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '志愿书id',
  `user_id` int(20) DEFAULT NULL COMMENT '用户id',
  `appf_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '提交时间',
  `appf_state` int(1) DEFAULT NULL COMMENT '状态',
  `appf_count` int(20) DEFAULT NULL COMMENT '志愿书次数',
...
CREATE TABLE `tb_tk_application` (
  `app_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '申请书id',
  `user_id` int(20) DEFAULT NULL COMMENT '用户id',
  `app_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '提交时间',
  `app_state` int(1) DEFAULT NULL COMMENT '状态',
  `app_count` int(20) DEFAULT NULL COMMENT '申请书次数',
  PRIMARY KEY (`app_id`)
...
CREATE TABLE `tb_tk_atsurpport` (
  `att_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '推荐id',
  `att_state` int(1) DEFAULT NULL COMMENT '状态（是否推荐积极分子）',
  `att_remark` varchar(255) DEFAULT NULL COMMENT '备注',
  `att_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '推荐时间',
  `user_id` int(20) DEFAULT NULL COMMENT '用户id',
  `att_state2` int(1) DEFAULT NULL COMMENT '状态2（是否具有入党资格)',
  PRIMARY KEY (`att_id`)
...
CREATE TABLE `tb_tk_branch` (
  `branch_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '支部id',
...
CREATE TABLE `tb_tk_convert` (
  `cont_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '转正书id',
  `user_id` int(20) DEFAULT NULL COMMENT '用户id',
  `cont_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '提交时间',
  `cont_state` int(1) DEFAULT NULL COMMENT '审核进度(状态)',
...
CREATE TABLE `tb_tk_develpobj` (
  `dobj_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '发展对象id',
  `user_id` int(20) DEFAULT NULL COMMENT '用户id',
  `dobj_state` int(1) DEFAULT NULL COMMENT '状态（是否称为发展对象）',
  `dobj_mark` varchar(255) DEFAULT NULL COMMENT '备注',
  `dobj_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '时间',
  PRIMARY KEY (`dobj_id`)
...
CREATE TABLE `tb_tk_dmemship` (
  `dship_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '联系人id',
  `user_id` int(20) DEFAULT NULL COMMENT '用户id',
  `dship_name` varchar(20) DEFAULT NULL COMMENT '联系人姓名',
  `dship_phone` int(20) DEFAULT NULL COMMENT '联系人电话',
...
CREATE TABLE `tb_tk_dreference` (
  `dref_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '党委备案id',
  `user_id` int(20) DEFAULT NULL COMMENT '用户id',
  `dref_state` int(1) DEFAULT NULL COMMENT '备案状态',
  `dref_mark` varchar(255) DEFAULT NULL COMMENT '备注',
  `dref_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '时间',
  `is_application` int(1) DEFAULT NULL COMMENT '入党申请书状态',
  `is_talk` int(1) DEFAULT NULL COMMENT '入党积极分子谈话表状态',
  `is_report` int(1) DEFAULT NULL COMMENT '思想汇报状态',
  `is_volun` int(1) DEFAULT NULL COMMENT '入党志愿书状态',
  `is_synth` int(1) DEFAULT NULL COMMENT '综合材料政审状态',
  `is_inspect` int(1) DEFAULT NULL COMMENT '入党积极分子考察表',
  `is_convert` int(1) DEFAULT NULL COMMENT '转正申请状态',
  PRIMARY KEY (`dref_id`)
...
CREATE TABLE `tb_tk_eadacord` (
  `eacord_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '审批记录id',
  `user_id1` int(20) DEFAULT NULL COMMENT '用户id',
  `dref_id` int(20) DEFAULT NULL COMMENT '备案id',
  `eacord_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '审批时间',
  `user_id2` int(20) DEFAULT NULL COMMENT '审批人id',
  `eacord_state` int(1) DEFAULT NULL COMMENT '是否通过',
...
CREATE TABLE `tb_tk_file` (
  `file_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '归档id',
  `user_id` int(20) DEFAULT NULL COMMENT '用户id',
  PRIMARY KEY (`file_id`)
...
CREATE TABLE `tb_tk_lecturecord` (
  `lcord_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '记录id',
  `lcord_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '记录时间',
  `user_id` int(20) DEFAULT NULL COMMENT '用户id',
  `lcord_state` int(1) DEFAULT NULL COMMENT '考勤状态',
  `lcord_grade` int(20) DEFAULT NULL COMMENT '考试成绩',
  `lcord_pass` int(20) DEFAULT NULL COMMENT '是否合格',
...
CREATE TABLE `tb_tk_oath` (
  `oath_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '宣誓id',
  `user_id` int(20) DEFAULT NULL COMMENT '用户id',
  `oath_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '宣誓时间',
  `oath_state` int(1) DEFAULT NULL COMMENT '是否宣誓',
...
CREATE TABLE `tb_tk_partymember` (
  `pm_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '党员id',
  `user_id` int(20) DEFAULT NULL COMMENT '用户id',
  `pm_from` int(20) DEFAULT NULL COMMENT '所属党支部',
  `pm_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入党时间',
  PRIMARY KEY (`pm_id`)
...
CREATE TABLE `tb_tk_political` (
  `pol_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '政审id',
  `user_id` int(20) DEFAULT NULL COMMENT '用户id',
  `pol_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '政审时间',
  `pol_content` varchar(255) DEFAULT NULL COMMENT '政审内容',
  `pol_state` int(1) DEFAULT NULL COMMENT '政审状态',
  PRIMARY KEY (`pol_id`)
...
CREATE TABLE `tb_tk_sendtalk` (
  `st_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '谈话id',
  `user_id1` int(20) DEFAULT NULL COMMENT '被谈话用户id',
  `st_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '谈话时间',
  `st_topic` varchar(255) DEFAULT NULL COMMENT '谈话主题',
  `user_id2` int(20) DEFAULT NULL COMMENT '谈话用户id',
...
CREATE TABLE `tb_tk_talkrecord` (
  `tkd_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '谈话记录id',
  `tkd_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '谈话时间',
  `user_id` int(20) DEFAULT NULL COMMENT '用户id',
  `tkd_content` int(255) DEFAULT NULL COMMENT '谈话内容',
  PRIMARY KEY (`tkd_id`)
...
CREATE TABLE `tb_tk_thoureport` (
  `thport_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '汇报id',
  `user_id` int(20) DEFAULT NULL COMMENT '用户id',
  `app_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '提交时间',
  `thport_content` varchar(255) DEFAULT NULL COMMENT '内容',
  `thport_state` int(1) DEFAULT NULL COMMENT '提交状态',
  `thport_count` int(20) DEFAULT NULL COMMENT '提交次数',
...
CREATE TABLE `tb_tk_tnrecord` (
  `tncord_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '记录id',
  `tncord_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '考察时间',
  `user_id` int(20) DEFAULT NULL COMMENT '用户id',
...
CREATE TABLE `tb_tk_totrain` (
  `totrain_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '集中培训id',
  `user_id` int(20) DEFAULT NULL COMMENT '用户id',
  `totrain_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '培训时间',
  `totrain_content` varchar(255) DEFAULT NULL COMMENT '培训内容',
  `totrain_mainp` varchar(20) DEFAULT NULL COMMENT '培训主持人',
  `totrain_state` int(1) DEFAULT NULL COMMENT '状态(是否参加此次培训)',
...
CREATE TABLE `tb_tk_trainer` (
  `trainer_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '培养人id',
  `trainer_name` varchar(255) DEFAULT NULL COMMENT '培养人姓名',
  `trainer_state` int(1) DEFAULT NULL COMMENT '身份状态',
  `branch_id` int(20) DEFAULT NULL COMMENT '隶属支部',
  `trainer_phone` int(20) DEFAULT NULL COMMENT '联系方式',
...
CREATE TABLE `tb_tk_user` (
  ...
  `user_phone` int(30) DEFAULT NULL COMMENT '手机号',
  ...
  `trainer_id` int(20) DEFAULT NULL COMMENT '培养人id',
  `trainer_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '指定培养人时间',
  `is_pass` int(1) DEFAULT NULL COMMENT '申请书是否通过',
  `is_att` int(1) DEFAULT NULL COMMENT '是否称为推优积极分子',
  `is_allin` int(1) DEFAULT NULL COMMENT '材料档案是否齐全',
  `is_course` int(1) DEFAULT NULL COMMENT '党课是否结业',
  `dship_id` int(20) DEFAULT NULL COMMENT '入党联系人',
  `user_sex` int(1) DEFAULT NULL COMMENT '性别',
  `user_pic` varchar(255) DEFAULT NULL COMMENT '头像',
  `user_mm` int(1) DEFAULT NULL COMMENT '身份面貌',
  PRIMARY KEY (`user_id`)
